      ...
      <div class='col-sm-6'>
        <div class="jumbotron oste">
          <div class="in text-center">
            <div class="row">
              <div class="col-2" style="transform: rotate(180deg); line-height: 1; writing-mode: vertical-lr; font-family: 'sifonn_basic', Arial, sans-serif; font-size: 4vw; border-left: 5px double black; ">
                De Watertoren
              </div>
